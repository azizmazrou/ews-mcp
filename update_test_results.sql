...
UPDATE test_cases
SET
    test_description = 'Send email to user@example.invalid with subject ''EWS MCP Test - Attachment Verification'', body ''Testing attachment functionality'', and attach /tmp/ews_test_files/test.txt. Report the tool''s response.',
...
UPDATE test_cases
SET
    test_description = 'Send email to user@example.invalid with attachments /tmp/ews_test_files/test.txt and /tmp/ews_test_files/test2.txt. Report success status and attachment_count.',
